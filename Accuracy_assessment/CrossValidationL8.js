...
var TraniningData = require("users/blackwhitezou/Thesis:Landsat8_pre_clasV2");
// The Phase and Amplitude value of harmonic feature for 2013
var TrainingPtL8 = TraniningData.TrainingPtL8;
...
var inputtedFeatureCollection = TrainingPtL8;

var k = 5;

var seed = 2500;

var classifierOfChoice = ee.Classifier.randomForest(50,seed);

var propertyToPredictAsString = 'class';

var scaleToSample = 30;

// **********Part 1: Preparation of the inputted feature collection of sample points**********//
...
// *************Part 2: This section divides the feature collection into the k folds*******
...
// ***************Part 3: Train the data and retrieve the values at the sample points************************//
...
// using test collection to get model estimation errors
  ...
  //   var RMSE1 = RMSE0.reduce(ee.Reducer.sum(), [0]).get([0]);  // reduce the array to the sum -> output is a ee.Number()
